// Automated deployment to a VPN using Jenkins. You can use the step below in your jenkinsfile to do automated deployments over VPN
node {
  try {
                ...
                withCredentials([string(credentialsId: 'your-vpn-username', variable: 'YOUR_VPN_USERNAME'),
                 string(credentialsId: 'your-url-encoded-vpn-pass', variable: 'YOUR_URL_ENCODED_VPN_PASSWORD')]) {
                  ...
                  // sha256:<hash> - is the oppen connect certificate validation hash
                   ...
                   sh "git clone http://${YOUR_VPN_USERNAME}:'${YOUR_URL_ENCODED_VPN_PASSWORD}'@github.com//repo_name/project_name.git ."
